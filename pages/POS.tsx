...
export default function POS() {
    ...
    // Produtos simulados para interação na UI pendente de integração com a Base de Dados
    const mockProducts = [
        { id: '1', nome_produto: 'Coca-Cola 330ml', codigo_produto: '7891000', preco_venda: 500, stock: 120 },
        { id: '2', nome_produto: 'Pão de Forma', codigo_produto: '7891001', preco_venda: 1200, stock: 45 },
        { id: '3', nome_produto: 'Teclado Mecânico RGB', codigo_produto: '7891002', preco_venda: 25000, stock: 12 },
        { id: '4', nome_produto: 'Cadeira Gamer', codigo_produto: '7891003', preco_venda: 185000, stock: 4 },
    ];
        ...
        <div className="min-h-screen bg-zinc-950 flex flex-col md:flex-row overflow-hidden font-sans">
            ...
            <div className="flex-1 flex flex-col h-screen border-r border-zinc-900 bg-[#0a0a0a]">
                ...
                <div className="p-4 bg-zinc-900 border-b border-zinc-800 flex items-center justify-between">
                    ...
                    <button className="text-zinc-500 hover:text-red-500 transition-colors p-2 hidden sm:block">
                        <LogOut size={20} />
                    </button>
                </div>
                        ...
                        {filteredProducts.map(produto => (
                            ...
                            >
                                ...
                                <div className="mt-4 flex items-end justify-between">
                                    ...
                                    <span className="text-[10px] uppercase tracking-wider text-emerald-500 bg-emerald-500/10 px-2 py-1 rounded-full font-bold">
                                        Stock: {produto.stock}
                                    </span>
                                </div>
                            </button>
            ...
            <div className="w-full md:w-[400px] lg:w-[450px] bg-zinc-900 h-screen flex flex-col shadow-2xl relative z-10">
                ...
                <div className="p-6 bg-zinc-950 border-t border-zinc-800 shadow-[0_-20px_50px_-20px_rgba(0,0,0,0.5)]">
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-4">
                        <button className="bg-zinc-900 border border-zinc-800 text-white p-4 justify-center rounded-2xl flex items-center gap-2 hover:bg-zinc-800 hover:border-zinc-700 transition-all group">
                    ...
                    >
                        ...
                        <div className="absolute inset-0 w-full h-full bg-yellow-400 scale-x-0 group-hover:scale-x-100 origin-left transition-transform duration-300 ease-out z-0"></div>
                    </button>
                </div>
