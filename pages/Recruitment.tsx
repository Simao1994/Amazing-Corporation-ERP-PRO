               ...
               <form onSubmit={handleSaveCandidatura} className="bg-white p-12 rounded-[4rem] shadow-3xl border border-sky-100 space-y-12">
                  ...
                  <div className="space-y-8">
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        />
                        <Select name="genero" label="Género" required defaultValue={editingItem?.genero} options={[{ value: 'Masculino', label: 'Masculino' }, { value: 'Feminino', label: 'Feminino' }, { value: 'Outro', label: 'Outro/Preferir não dizer' }]} />
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <Input name="municipio" label="Município / Cidade" required defaultValue={editingItem?.municipio} placeholder="Ex: Baía Farta" />
                     </div>
                     <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="space-y-8">
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <Input name="pretensao_salarial" label="Pretensão Salarial (AOA)" type="number" defaultValue={editingItem?.pretensao_salarial} placeholder="Opcional" />
                        <Input name="linkedin_url" label="LinkedIn / Portfólio" defaultValue={editingItem?.linkedin_url} placeholder="https://linkedin.com/in/..." icon={<Globe size={14} />} />
                     </div>
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="flex items-center gap-4 bg-zinc-50 p-6 rounded-2xl border border-zinc-200">
                           <label className="text-[11px] font-black text-zinc-700 uppercase tracking-widest flex-1">Possui alguma deficiência?</label>
                  ...
                  <div className="space-y-8">
                     <div className="flex items-center gap-4 bg-zinc-50 p-6 rounded-2xl border border-zinc-200">
                        ...
                        <label className="text-[11px] font-black text-zinc-700 uppercase tracking-widest flex-1">
                           Declaro que li e aceito os <a href="#" className="text-yellow-500 hover:underline">Termos e Condições</a> de Tratamento de Dados
                        </label>
                     </div>
