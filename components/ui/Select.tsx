...
const Select: React.FC<SelectProps> = ({ label, options, error, className, ...props }) => {
  return (
    <div className="w-full">
      ...
      <select 
        className={`w-full px-4 py-2 bg-white border rounded-lg text-zinc-900 text-sm outline-none transition-all focus:ring-2 focus:ring-yellow-500/20 focus:border-yellow-500 appearance-none ${
